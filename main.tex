...
U ovoj sekciji opisujemo dizajn rješenja za aplikaciju \textit{MeetingPlanner}, koja se sastoji od klijentskih i poslužiteljskih komponenti. UML class dijagrami koji prate ovaj opis ilustriraju strukturu ključnih klasa i njihovu međusobnu povezanost.
...
\end{figure}
Ovo je sva potrebna logika za klijentski dio sustava {engl. \textit{Frontend}}. Potrebno je implementirati poslužiteljski dio {eng. \textit{Backend}}.
